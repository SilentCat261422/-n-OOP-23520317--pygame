...
upgrade_turret_image = pg.image.load('assets/images/buttons/change_turret.png').convert_alpha()
...
def create_turret(mouse_pos):
  ...
  if world.tile_map[mouse_tile_num] == 7:
    ...
    if space_is_free == True:
      ...
      #inflation of buy cost
      c.BUY_COST += c.INFLATION
      c.INFLATION += 15
  ...
  if game_over == False:
    ...
    if level_started == False:
      ...
      if fast_forward_button.draw(screen):
        world.game_speed = 2
      #spawn enemies
      if pg.time.get_ticks() - last_enemy_spawn > random.randint(20, 2000):
